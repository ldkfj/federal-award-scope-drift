...
- Wallet support is limited to injected browser EIP-1193 providers. EIP-6963 discovery is used first; when OKX also exposes its dedicated injected namespace, that exact provider is preferred over an aggregate browser router. This release does not claim WalletConnect, mobile, hardware-wallet, or smart-account support.
